...
const config = {
  ...
  businessProductIds: toList(process.env.BUSINESS_PRODUCT_IDS, ["salespos_business", "salepos_growth"]),
  ...
  mmqrEnabled: toBool(process.env.MMQR_ENABLED, false),
  mmqrSandboxEnabled: toBool(process.env.MMQR_SANDBOX_ENABLED, true),
  mmqrAppId: process.env.MMQR_APP_ID || "",
  mmqrPublishableKey: process.env.MMQR_PUBLISHABLE_KEY || "",
  mmqrSecretKey: process.env.MMQR_SECRET_KEY || "",
  mmqrApiBaseUrl: process.env.MMQR_API_BASE_URL || "",
  mmqrCallbackUrl: process.env.MMQR_CALLBACK_URL || "",
  starterAmountMmk: toInt(process.env.STARTER_AMOUNT_MMK, 3000),
  businessAmountMmk: toInt(process.env.BUSINESS_AMOUNT_MMK, 5000),
  proAmountMmk: toInt(process.env.PRO_AMOUNT_MMK, 10000),
